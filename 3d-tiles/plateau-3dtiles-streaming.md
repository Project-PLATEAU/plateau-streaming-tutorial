...
> :warning: APIのスキーマやレスポンスは予告なく変更されることがあります。また、提供期間やサービスレベルの保証もしておりません。ご了承の上ご利用ください。

> :warning: このAPIはレスポンスのサイズが大きく、約2MB以上あります。APIはgzip圧縮に対応していますが、モバイル回線などで使用する際は十分ご注意ください。
...
> :warning: GraphQLのスキーマやレスポンスは予告なく変更されることがあります。また、提供期間やサービスレベルの保証もしておりません。ご了承の上ご利用ください。

> :warning: このAPIはクエリによってはレスポンスのサイズが数MB以上と大きくなることがあります。APIはgzip圧縮に対応していますが、モバイル回線などで使用する際は十分ご注意ください。また、動作速度低下を防ぐため、一定以上の複雑なクエリは制限されます。
